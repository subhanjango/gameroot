                ...
                <form class="m-form" method="{{$Method}}" action="{{$Action}}">
                  ...
                  <div class="m-portlet__body">
                    <div class="m-form__section m-form__section--first">
                        ...
                        <input type="text" value="{{old('g_name')}}" name="g_name" class="form-control m-input" placeholder="Group Name Please">
                      </span>
                    </div>
                      <div class="form-group m-form__group">
                        <label>
                        ...
                        <select name="users[]" multiple="true" id="select2" class="form-control ">
                          @if(!empty($myUsers))
                          @foreach($myUsers as $myUsers)
                          <option value="{{$myUsers->id}}">{!!$myUsers->email!!}</option>
                          @endforeach
                          @endif
                        </select>
                      </div>
