...
<html lang="en" >
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-1" id="m_login" style="background-image: url({{url('/assets/app/media/img//bg/bg-1.jpg')}});">
  ...
  @endforeach
				...
				<div class="m-login__signin">
							...
							<form method="{{$method}}" action="{{$action}}" class="m-login__form m-form" >
