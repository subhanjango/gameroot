...
Add New Sub Category</span> </span></a>
</div>
</div>
<!-- END: Subheader -->
<div class="m-content">
...
<label class="switch">
<input onchange="changestatus({{$SubCategories->id}})" checked type="checkbox">
<span class="slider round"></span>
</label></td>
@else
<label class="switch">
<input onchange="changestatus({{$SubCategories->id}})"  type="checkbox">
<span class="slider round"></span>
</label></td>
@endif
